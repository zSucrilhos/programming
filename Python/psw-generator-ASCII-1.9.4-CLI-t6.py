...
def gen_psw(how_many_psws, psw_length, psw_type):
	"""
	...
	# Generate more than one password at once
	for i in range(0, how_many_psws):
...
5 - Mixed 12ab!@\n\t"
	...
	gen_psw(how_many_psws, psw_length, psw_type)
