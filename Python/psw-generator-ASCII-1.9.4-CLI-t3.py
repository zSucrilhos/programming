...
if __name__ == '__main__':
	...
	parser.add_argument("psw_type", type=int, help="The lenght of the password to be generated")
	parser.add_argument("psw_type", type=int, help="The type of the password to be generated.\n\
Possible types are:\n\t\
1 - UPPERCASE ONLY\n\t\
2 - lowercase only\n\t\
3 - 1234567890 only\n\t\
